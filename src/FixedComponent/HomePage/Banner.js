  ...
  return (
    <div className="hero p-20">
      <div className="hero-content flex-col lg:flex-row-reverse">
        <img
          src={golamrasul}
          className="bg-success mr-16 rounded-full"
          alt=""
        />
        <div className="">
          <h3 className="text-xl font-bold ml-1 text-deepBlack">Hello, I'm </h3>
          <h2 className="text-5xl font-bold text-deepBlack">MD.GOLAM RASUL</h2>
          <div className="">
          ...
          <p className="py-10 text-justify font-sans text-xl ">
